...
// Messages
export const CHAT_ROOM_WILL_ENTER = 'CHAT_ROOM_WILL_ENTER'
export const CHAT_ROOM_MESSAGES_REQUEST = 'CHAT_ROOM_MESSAGES_REQUEST'
export const CHAT_ROOM_MESSAGES_RESPONSE = 'CHAT_ROOM_MESSAGES_RESPONSE'
